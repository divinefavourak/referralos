    ...
    <div className="space-y-6 pb-12">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="rounded-full bg-sky-200/80 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider text-sky-950">
                Stage 3 of 4 • Ambulance Telematics
              </span>
              <span className="text-xs font-bold text-slate-900">ALS Unit 04 • Paramedic Kelechi &amp; Driver Samuel</span>
            </div>
            <p className="text-xs text-slate-700 mt-1 font-medium leading-relaxed">
              Transporting <strong>Amara Okoro</strong> with continuous live vital telemetry. If the destination hospital suffers a capacity failure, the navigation console automatically redirects without phone delays.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-rose-200 bg-rose-50/80 p-5 sm:p-6 shadow-xs">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-rose-600 text-white shrink-0 shadow-sm shadow-rose-600/20">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs lg:col-span-8 relative overflow-hidden">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3.5 mb-4">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-500 font-semibold">
              <span className="h-2 w-2 rounded-full bg-emerald-600 ring-4 ring-emerald-600/20" />
        ...
        <div className="space-y-6 lg:col-span-4">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs text-center">
            ...
            <div className="mx-auto flex h-32 w-32 items-center justify-center rounded-2xl bg-slate-50 p-2.5 border border-slate-200 shadow-2xs">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-xs">
        ...
        >
          ...
          <span>Previous: Hospital ER Desk (Stage 2)</span>
        </button>

        <div className="text-center">
          <span className="text-[10px] font-bold uppercase text-slate-400">Current Progress</span>
          <p className="text-xs font-bold text-slate-900">Stage 3: Real-Time Corridor Navigation &amp; Telematics</p>
        </div>
        ...
        >
          <span>Next: Emergency Case Walkthrough (Stage 4)</span>
